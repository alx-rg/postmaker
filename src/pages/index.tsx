  ...
  return (
    <>
      ...
      {/* <div className="w-screen min-h-screen flex flex-col justify-center items-center p-4 overflow-y-scroll">
        <h2 className="w-screen flex flex-row justify-center text-[3rem] lg:text-[5rem] md:text-[5rem] font-extrabold text-gray-700">
          Your <span className="text-blue-500">Future</span> Starts <span className="text-blue-600">Here</span> 
        </h2>
